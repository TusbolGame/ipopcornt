                            ...
                            <div class="col-12">
                                <div class="form-group">
                                    ...
                                    <div v-if="data_actors_search === null" class="row">
                                        ...
                                        <div class="col-8 col-sm-3 mt-2 add-actor" v-for="(item,index) in data_actors.actors.data" :key="index" @click="ADD_ACTOR(index,'default')" v-if=" data_actors.actors !== null">

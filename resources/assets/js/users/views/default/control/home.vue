                                    ...
                                    <div class="hidden-sm-down poster">
                                        ...
                                        <div class="control">
                                            <div class="btn-group">
                                                ...
                                                <router-link role="button" class="btn btn-sm btn-warning" :to="{name: 'movie-player', params: {id: item.id}}" v-if="item.player == 'local' || item.player == 'link' ">
                                                    {{$t('home.play')}}
                                                ...
                                                <router-link role="button" class="btn btn-sm btn-warning" :to="{name: 'movie-player-embed', params: {id: item.id}}" v-else>
                                                    {{$t('home.play')}}
                                    ...
                                    <div class="hidden-sm-down poster">
                                        ...
                                        <div class="control">
                                            <div class="btn-group">
                                                ...
                                                <router-link role="button" class="btn btn-sm btn-warning" :to="{name: 'series-player-current', params: {series_id: item.id}}" v-if="item.player == 'default'">
                                                    {{$t('home.play')}}
                                                ...
                                                <router-link role="button" class="btn btn-sm btn-warning" :to="{name: 'series-player-embed-current', params: {series_id: item.id}}" v-else>
                                                    {{$t('home.play')}}
            ...
            <div class="col-12">
                <div class="row" style="margin: -30px; overflow: hidden;">
                    <div class="col-12 p-0">
                        <div class="recenlty" v-if="data.recenlty !== null && $auth.isAuthenticated() === 'active' ">
                            <div class="ml-4">
                                                    ...
                                                    <div class="body text-center">
                                                        ...
                                                        <div class="play">
                                                            ...
                                                            <div v-if="item.already_episode !== 0 && item.already_episode !== null">
                                                                ...
                                                                <router-link :to="{name: 'series-player-current', params: {series_id: item.id}}" v-if="item.player == 'local' || item.player == 'link'">
                        ...
                        <div class="carousel mt-1 m-3 mb-5" v-for="(item, rootindex) in data.data" :key="rootindex" v-if="item.list.length > 0 ">
                            ...
                            <carousel class="list-carousel" navigationPrevLabel='<svg xmlns="http://www.w3.org/2000/svg" xmlns:xlink="http://www.w3.org/1999/xlink" version="1.1" viewBox="0 0 129 129" enable-background="new 0 0 129 129" width="100%" class="arrow-right-svg"><g><g>
                                ...
                                <slide class="col-6 col-md-4 col-lg-2 col-xxl-1-5 m-2 m-4 animation" v-for="(item, index) in data.data[rootindex].list" :key="index">
